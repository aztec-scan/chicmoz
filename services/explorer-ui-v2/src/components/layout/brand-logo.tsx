...
/** Purple AS logo used by the topbar. Stroked as an inline SVG so `fill: currentColor` is easy. */
export const BrandLogo: FC = () => (
  <svg viewBox="0 0 200.17 160" xmlns="http://www.w3.org/2000/svg" aria-hidden>
