...
export const NextBlockCountdown: FC<NextBlockCountdownProps> = ({
  ...
  if (isLoading) {
    return (
      <div className="w-full px-4 py-6 text-gray-500">
        <p className="text-center mb-3">Loading block data...</p>
  ...
  if (error) {
    return (
      <div className="w-full px-4 py-6 text-red">
        <p className="text-center mb-3">Error loading block data: {error.message}</p>
      </div>
    );
  }
