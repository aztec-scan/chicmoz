      ...
      <div className="flex flex-col items-center">
        ...
        <div className="bg-white w-full rounded-lg shadow-md p-4 md:w-2/3 mb-6">
          <p className="mb-4">
            ...
            currently a work in progress. Any suggestions or feedback are
            welcome as an issue on our github.
          </p>
        ...
        <div className="flex flex-wrap md:w-2/3 mb-6">
          <p className="text-sm text-gray-600 mb-4 px-4">
            ...
            they have a known origin. IT DOES NOT MEAN THAT THEY ARE A) AUDITED
            OR B) SAFE TO USE.
            <br />
            <br />
            Please do your own research and due diligence before interacting
