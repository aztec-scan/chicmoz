...
export const JsonDisplay: FC<JsonDisplayProps> = ({
  ...
  const renderNode = (
    ...
    const getFunctionName = (obj: unknown): string | null => {
      if (typeof obj !== "object" || !obj) {
        return null;
      }

      const typedObj = obj as Record<string, unknown>;
      if (typedObj.name && typeof typedObj.name === "string") {
        return typedObj.name;
      }
      if (typedObj.functionName && typeof typedObj.functionName === "string") {
        return typedObj.functionName;
      }
