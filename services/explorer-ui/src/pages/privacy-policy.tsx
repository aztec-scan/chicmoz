    ...
    <BaseLayout>
      <div className="flex flex-col items-center">
        ...
        <div className="bg-white w-full rounded-lg shadow-md p-4 md:w-3/4 space-y-4">
          ...
          <h4>Analytics</h4>
          <p>
            We use a self-hosted instance of Plausible Analytics to collect
            anonymous usage statistics about our website. As we self-host this
            solution, your data is not shared with any third-party analytics
            providers and remains under our control on our servers located in
            the EU.
          </p>
          ...
          <p>
            ...
            to improve the user experience. All analytics data is subject to our
            standard 6-month retention period as specified in this privacy
            policy.
          </p>
          ...
          <p>
            ...
            information for longer than 6 months past the termination of the
            user's account. When we have no ongoing legitimate business need to
          ...
          <p>
            ...
            modify your information. Although we will do our absolute best to
          ...
          <p>
            ...
            <a href="mailto:info@obscura.network">info@obscura.network</a>, or
          ...
          <p>
            ...
            about who we disclose personal information to in the section, "WHEN
            AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?" We may use
          ...
          <p>
            California Residents California Civil Code Section 1798.83, also
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              whether we sell or share your personal information to third
              parties;{" "}
            </li>
            <li>
          ...
          <p>
            ...
            you exercise your privacy rights. Right to Limit Use and Disclosure
          ...
          <p>
            ...
            to hear from you. Colorado Residents This section applies only to
            Colorado residents. Under the Colorado Privacy Act (CPA), you have
          ...
          <p>
            ...
            (CTDPA), you have the rights listed below. However, these rights are
          ...
          <p>
            ...
            employment context. "Personal data" means any information that is
            linked or reasonably linkable to an identified or identifiable
            natural person. "Personal data" does not include de-identified data
