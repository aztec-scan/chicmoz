...
export class SimpleLoggingContract extends ContractBase {
  ...
  public declare methods: {
    ...
    increment_and_decrement: ((owner: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** increment_self_and_other(other_counter: struct, owner: struct) */
    increment_self_and_other: ((other_counter: AztecAddressLike, owner: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** increment_twice(owner: struct) */
    increment_twice: ((owner: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
