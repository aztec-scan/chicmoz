...
export const SCENARIO_AZTEC_STANDARD_TOKEN_CONTRACT_LEGACY =
  process.env.SCENARIO_AZTEC_STANDARD_TOKEN_CONTRACT_LEGACY === "true";
export const SCENARIO_AZTEC_STANDARD_TOKEN_CONTRACT_CURRENT =
  process.env.SCENARIO_AZTEC_STANDARD_TOKEN_CONTRACT_CURRENT === "true";
export const SCENARIO_VERIFY_SOURCE_CODE =
